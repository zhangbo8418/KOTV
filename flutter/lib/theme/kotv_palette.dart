...
class KotvPalette extends ThemeExtension<KotvPalette> {
  ...
  static const defaults = KotvPalette(
    ...
    input: Color(0xFF582D91),
    pillBg: Color(0xE618161E),
    pillBorder: Color(0xC84A4855),
    statusBar: Color(0x60551C72),
    catBar: Color(0x4D653AA8),
    bottomNav: Color(0xEE1A0F2E),
    dialogBg: Color(0xFA3B1970),
    posterBar: Color(0xCC653AA8),
    posterPh: Color(0xFF3A1A6E),
    selected: Color(0xF2C73C62),
  ...
  static KotvPalette resolve(String mode, bool light) {
    ...
    var p = light
        ? const KotvPalette(
            ...
            statusBar: Color(0xF0F4F6FC),
            catBar: Color(0xE8EEF0F8),
            bottomNav: Color(0xF5FCF8FF),
            dialogBg: Color(0xF8FCF8FF),
            posterBar: Color(0xF2FFFFFF),
      ...
      case 'builtin2':
        p = light
            ? p.copyWith(
                ...
                bottomNav: _c(0xF5FFF5F8),
                dialogBg: _c(0xF8FFF0F5),
                posterBar: _c(0xF2FFFFFF),
                posterPh: _c(0xFFE8B0C0),
                selected: _c(0xF2C73C62),
                focus: _c(0xFFE91E63),
      ...
      case 'builtin3':
        p = light
            ? p.copyWith(
                ...
                bottomNav: _c(0xF5F0F4F6),
                dialogBg: _c(0xF8E8F0F2),
                posterBar: _c(0xF2FFFFFF),
                posterPh: _c(0xFFB0C8D0),
                selected: _c(0xF24DA8DA),
                focus: _c(0xFF266E8C),
